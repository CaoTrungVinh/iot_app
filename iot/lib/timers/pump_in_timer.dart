...
class _Pump_In_TimerState extends State<Pump_In_Timer> {
  ...
  Future<void> getTimer_Device() async {
    if (isLoading) return;
    isLoading = true;
    await getPumpIn().then(
          (value) {
        ...
        setState(() {
          ...
          // String min = output[0].trim();
          // String minaa = output[1].trim();
          // print(min);
          // print(minaa);
        });
        isLoading = false;
  ...
  void initState() {
    ...
    getTimer_Device();
    // if (min_temp.isEmpty){
    //   _dateController_On.text =  min_temp;
    //
    // }else{
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () async {
                print('Post data');
                await Timer_Device_PumpIn_On_Off(
