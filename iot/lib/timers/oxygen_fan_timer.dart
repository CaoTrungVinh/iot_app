...
class Oxygen_Fan_Timer extends StatefulWidget {
  @override
  _Oxygen_Fan_TimerState createState() => _Oxygen_Fan_TimerState();
}

class _Oxygen_Fan_TimerState extends State<Oxygen_Fan_Timer> {
            ...
            child: ListBody(
              children: <Widget>[
                device == 0 || device == 2
                    ...
                    : Text('Vui lòng tắt quạt và nhập lại'),
              ],
            ),
          ),
          actions: <Widget>[
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('Bật quạt: ' + date_on.toString()),
                Text('Tắt quạt: ' + date_off.toString()),
              ],
            ),
          ),
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () async {
                print('Post data');
                await set_timer_oxygen_fan(timer_on, timer_off).then((value) {
                  print(value);
                });
                Navigator.of(context).pop();
              },
